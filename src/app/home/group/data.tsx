...
export const group = [
    {name: "Daisy Martins", image: "", work: "Coordenadora", description: "Descrição da Coordenadora do projeto", link: ""},
    {name: "Levi Júnior", image: leviImage, work: "Dev. BackEnd e FrontEnd", description: "Descrição do aluno", link: "https://github.com/levijunior21"},
    {name: "Thalita Hernesto", image: "", work: "Colaboradora", description: "Descrição do aluno", link: ""},
